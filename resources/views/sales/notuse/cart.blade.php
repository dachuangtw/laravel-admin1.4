			...
			<div class="wrap-table-text bgwhite">
				<table class="table-text">
					...
					<tr class="table-row">
						<td class="column">
							<div class="cart-img-product">
								<img src="{{ asset(config('sales.asset_path') . 'images/item-10.jpg') }}">
							</div>
						</td>
						<td class="column">Tshirt</td>
					...
					<tr class="table-row">
						<td class="column">
							<div class="cart-img-product">
								<img src="{{ asset(config('sales.asset_path') . 'images/item-05.jpg') }}" alt="IMG-PRODUCT">
							</div>
						</td>
						<td class="column">Adventure</td>
					...
					<tr class="table-row">
						<td class="column-1">
							<div class="cart-img-product b-rad-4 o-f-hidden">
								<img src="{{ asset(config('sales.asset_path') . 'images/item-10.jpg') }}" alt="IMG-PRODUCT">
							</div>
						</td>
